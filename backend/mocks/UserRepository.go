...
// Create provides a mock function with given fields: ctx, tx, properties
func (_m *UserRepository) Create(ctx context.Context, tx database.Tx, properties ent.User) (*ent.User, error) {
	ret := _m.Called(ctx, tx, properties)
